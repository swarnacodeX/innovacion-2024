...
import { startingFeatures1 } from '../components/constants';
import { StartSteps1, TitleText, TypingText } from '../components';
  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <TitleText title={<>School Registration</>} />
        ...
        <div>
        <Link href='https://forms.gle/F1yaYdBFDttmQ68F8'>
