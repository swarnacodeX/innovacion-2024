  ...
  return (
    <div
      ...
      <div
        ...
        <div
          className="relative float-start -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
          data-te-carousel-item
          data-te-carousel-active>
          <Image
            src="/asd/08.jpg"
            className="block w-full"
            alt="Wild Landscape"  width={805} height={505} />
        </div>
        ...
        <div
          ...
          <Image
            src="/asd/29.jpg"
            className="block w-full"
            alt="Exotic Fruits"  width={800} height={505} />
        </div>
